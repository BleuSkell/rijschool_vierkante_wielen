        ...
        <div class="w-full max-w-lg bg-gray-900 rounded-lg shadow-lg p-2">
            ...
            <form method="POST" action="{{ route('autos.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="brand" id="brand" class="w-full rounded px-3 py-2 bg-gray-700 text-white placeholder-gray-300" required>
                </div>
                <div class="mb-4">
                    <label class="block text-white mb-2" for="model">Model</label>
                    <input type="text" name="model" id="model" class="w-full rounded px-3 py-2 bg-gray-700 text-white placeholder-gray-300" required>
                </div>
                <div class="mb-4">
                    <label class="block text-white mb-2" for="licensePlate">Kenteken</label>
                    <input type="text" name="licensePlate" id="licensePlate" class="w-full rounded px-3 py-2 bg-gray-700 text-white placeholder-gray-300" required>
                </div>
                <div class="mb-4">
                    <label class="block text-white mb-2" for="fuelType">Brandstof</label>
                    <select name="fuelType" id="fuelType" class="w-full rounded px-3 py-2 bg-gray-700 text-white" required>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="note" id="note" class="w-full rounded px-3 py-2 bg-gray-700 text-white placeholder-gray-300"></textarea>
                </div>
